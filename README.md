...
Quick start
bash# Run the CLI demo (football + volleyball + save/load)
...
cmdbuild-installer.bat
The script does three things:

mvn clean package — builds the application JAR
mvn dependency:copy-dependencies — stages JavaFX jars into target/deps
jpackage — produces the .msi using a jlinked runtime image that includes the JavaFX modules (controls, fxml, graphics)
